...
<div class="payment-form">
    ...
    <?= $form->field($model, 'type_pay_id')->dropDownList(ArrayHelper::map(app\models\TypePay::find()->all(), 'id', 'name'), ['class' => 'form-control', 'prompt' => '','id'=>"type_pay_id"])->label(Yii::t('app', 'ປະ​ເພດ​ໃຊ້​ຈ່າຍ')) ?>
