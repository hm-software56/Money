...
<div class="bg-form">
    ...
    $bg_footer_over = array('black' => 'Black/ສີດຳ', 'blue' => 'Blue/ສີຟ້າ', 'green' => 'Green/ສີຂຽວ', 'purple' => 'Purple/ສີມ່ວງ', 'red' => 'Red/ສ​ີ​ແດງ', 'yellow' => 'Yellow​/ສີ​ເຫຼີອງ');
    ...
    <?= $form->field($model, 'bg_button_over')->dropDownList($bg_footer_over) ?>
